...
export class PerusahaanController {
  async createPerusahaan(req: Request, res: Response, db: DataSource): Promise<Response> {
  ...
  async searchPerusahaan(req: Request, res: Response, db: DataSource): Promise<Response> {
    const { q } = req.query
    try {
  ...
  async getPerusahaanById(req: Request, res: Response, db: DataSource): Promise<Response> {
    const { id } = req.params
    try {
  ...
  async updatePerusahaan(req: Request, res: Response, db: DataSource): Promise<Response> {
    const { id } = req.params
    try{
      const perusahaanEntity = await findPerusahaanById(id, db)
      if (perusahaanEntity == null)
  ...
  async deletePerusahaanById(req: Request, res: Response, db: DataSource): Promise<Response> {
    const {id} = req.params
    try {
      const perusahaanEntity = await findPerusahaanById(id, db)
      if (perusahaanEntity == null)
